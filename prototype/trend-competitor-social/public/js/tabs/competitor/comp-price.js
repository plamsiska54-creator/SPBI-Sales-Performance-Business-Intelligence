...
const PRICE_TABLE_DATA = [
  { product: 'ขนมปังแซนวิช',  ours: 35,  compA: 32,  compB: 38,  market: 35 },
  { product: 'เค้กช็อกโกแลต',  ours: 185, compA: 165, compB: 220, market: 190 },
  { product: 'โดนัทแก้ว',      ours: 25,  compA: 22,  compB: 28,  market: 25 },
  { product: 'คุกกี้เนยสด',    ours: 45,  compA: 40,  compB: 55,  market: 47 },
  { product: 'ครัวซองต์',      ours: 55,  compA: 48,  compB: 65,  market: 56 }
];

// ราคาต่อกรัม
const PRICE_PER_GRAM = [
  { product: 'ขนมปังแซนวิช', wanwanach: 0.44, snp: 0.43, afteryou: null, farmhouse: 0.36, yamazaki: 0.39, lepain: 0.64 },
  { product: 'เค้กช็อกโกแลต', wanwanach: 1.06, snp: 1.50, afteryou: 1.38, farmhouse: 0.94, yamazaki: 1.11, lepain: 2.44 },
  { product: 'ครัวซองต์',     wanwanach: 0.79, snp: 0.93, afteryou: 1.21, farmhouse: 0.50, yamazaki: 0.64, lepain: 1.36 },
  { product: 'คุกกี้เนยสด',   wanwanach: 0.56, snp: 0.73, afteryou: 0.95, farmhouse: 0.45, yamazaki: 0.50, lepain: 1.23 }
];

// ราคาปกติ vs ราคาโปรโมชั่น
const NORMAL_VS_PROMO = [
  { brand: 'วรรณวนัช', brandId: 'wanwanach', normal: 65,  promo: 55 },
  { brand: 'S&P',       brandId: 'snp',       normal: 75,  promo: 60 },
  { brand: 'After You', brandId: 'afteryou',  normal: 165, promo: 140 },
  { brand: 'ฟาร์มเฮ้าส์', brandId: 'farmhouse', normal: 45,  promo: 36 },
  { brand: 'ยามาซากิ',   brandId: 'yamazaki',  normal: 55,  promo: 47 },
  { brand: 'เลอแปง',     brandId: 'lepain',    normal: 135, promo: 120 }
];
...
function renderContent(container, data, filters) {
  ...
  const allBrandIds = ['wanwanach', 'snp', 'afteryou', 'farmhouse', 'yamazaki', 'lepain'];
  const brandNames = { wanwanach: 'วรรณวนัช', snp: 'S&P', afteryou: 'After You', farmhouse: 'ฟาร์มเฮ้าส์', yamazaki: 'ยามาซากิ', lepain: 'เลอแปง' };
