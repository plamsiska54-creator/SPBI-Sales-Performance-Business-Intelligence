...
const CATEGORY_DATA = {
  ...
  breakdown: {
    ...
    snp:       [20, 18, 15, 12, 8, 12],
    afteryou:  [15, 3, 5, 4, 2, 6],
    farmhouse: [5, 45, 8, 10, 25, 27],
    yamazaki:  [8, 15, 6, 12, 10, 14],
    lepain:    [6, 8, 4, 6, 1, 3]
  }
};
...
const CATEGORY_RATINGS = {
  ...
  ratings: {
    wanwanach: [4.3, 4.0, 4.2, 4.1, 3.8],
    snp:       [4.2, 4.0, 3.8, 3.9, 4.1],
    afteryou:  [4.8, 3.5, 4.5, 4.3, 4.0],
    farmhouse: [3.2, 4.2, 3.5, 3.3, 3.8],
    yamazaki:  [3.9, 4.1, 3.7, 4.2, 3.6],
    lepain:    [4.5, 4.3, 4.0, 4.6, 3.5]
  }
};
