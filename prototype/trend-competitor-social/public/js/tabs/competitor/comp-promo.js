...
const PROMO_BY_BRAND = {
  brands: [
    ...
    { id: 'farmhouse', name: 'ฟาร์มเฮ้าส์' },
    { id: 'yamazaki',  name: 'ยามาซากิ' },
    { id: 'wanwanach', name: 'วรรณวนัช' },
    { id: 'lepain',    name: 'เลอแปง' }
  ],
  // [ลดราคา, ซื้อ1แถม1, ซื้อ2แถม1, Bundle, Coupon, Member Price, เทศกาล, ตาม Channel]
  data: {
    snp:       [3, 2, 1, 1, 2, 1, 1, 2],
    afteryou:  [2, 1, 0, 2, 1, 1, 2, 0],
    farmhouse: [3, 2, 1, 0, 2, 0, 1, 3],
    yamazaki:  [1, 1, 1, 1, 0, 1, 0, 1],
    wanwanach: [2, 1, 1, 1, 2, 1, 1, 1],
    lepain:    [1, 0, 0, 1, 0, 0, 1, 0]
  }
};
...
const PROMO_TABLE = [
  { brand: 'S&P',        brandId: 'snp',       type: 'ลดราคา',      detail: 'ลด 20% ขนมปังทุกชนิด',              period: '1-15 มิ.ย.',  discount: '20%',  channel: 'ทุกสาขา',     impact: 'high' },
  { brand: 'After You',  brandId: 'afteryou',  type: 'Bundle',      detail: 'เค้ก+เครื่องดื่ม set 299',            period: '1-30 มิ.ย.',  discount: '15%',  channel: 'ร้าน',        impact: 'mid' },
  { brand: 'ฟาร์มเฮ้าส์', brandId: 'farmhouse', type: 'ซื้อ1แถม1',  detail: 'ขนมปังแซนวิช ซื้อ1แถม1',             period: '1-14 ก.ค.',  discount: '50%',  channel: '7-11',        impact: 'high' },
  { brand: 'ยามาซากิ',   brandId: 'yamazaki',  type: 'ซื้อ2แถม1',   detail: 'ครัวซองต์ทุกรส ซื้อ2แถม1',            period: '1-31 ก.ค.',  discount: '33%',  channel: 'ห้างสรรพสินค้า', impact: 'mid' },
  { brand: 'วรรณวนัช',   brandId: 'wanwanach', type: 'Coupon',      detail: 'คูปองลด 10% สั่งออนไลน์ครั้งแรก',     period: '15-31 ก.ค.', discount: '10%',  channel: 'Online',      impact: 'low' },
  { brand: 'เลอแปง',     brandId: 'lepain',    type: 'เทศกาล',      detail: 'เทศกาลครัวซองต์ฝรั่งเศส ลด 30%',      period: '14-20 ก.ค.', discount: '30%',  channel: 'ร้าน',        impact: 'mid' },
  { brand: 'S&P',        brandId: 'snp',       type: 'Member Price', detail: 'สมาชิก S&P Reward ลดเพิ่ม 5%',       period: '1 ก.ค.-31 ส.ค.', discount: '5%', channel: 'ทุกสาขา',   impact: 'low' },
  { brand: 'After You',  brandId: 'afteryou',  type: 'ลดราคา',      detail: 'Mid-Year Sale ลด 30% เมนูที่ร่วม',    period: '1-31 ก.ค.',  discount: '30%',  channel: 'ร้าน/Online', impact: 'high' },
  { brand: 'ฟาร์มเฮ้าส์', brandId: 'farmhouse', type: 'ตาม Channel', detail: 'ลด 5 บาททุกชิ้นเฉพาะ 7-11',          period: '1-31 ส.ค.',  discount: '10-15%', channel: '7-11',      impact: 'mid' },
  { brand: 'วรรณวนัช',   brandId: 'wanwanach', type: 'ซื้อ1แถม1',   detail: 'คุกกี้ซื้อ1แถม1 ทุกวันศุกร์',         period: 'ทุกศุกร์ ส.ค.', discount: '50%', channel: 'ร้าน/CJ',   impact: 'mid' },
  { brand: 'S&P',        brandId: 'snp',       type: 'Bundle',      detail: 'Set ขนมปัง+เค้ก+กาแฟ ราคาพิเศษ',     period: '1-15 ส.ค.',  discount: '20%',  channel: 'ทุกสาขา',     impact: 'mid' },
  { brand: 'ยามาซากิ',   brandId: 'yamazaki',  type: 'ลดราคา',      detail: 'ลด 15% กลุ่ม Classic ทุกรสชาติ',      period: '1-14 ส.ค.',  discount: '15%',  channel: 'MT',          impact: 'low' },
  { brand: 'ฟาร์มเฮ้าส์', brandId: 'farmhouse', type: 'Coupon',      detail: 'คูปอง LINE ลด 5 บาท',                period: '1-31 ส.ค.',  discount: '฿5',   channel: 'Online',      impact: 'low' },
  ...
  { brand: 'After You',  brandId: 'afteryou',  type: 'เทศกาล',      detail: 'Limited Edition เค้กวันแม่',            period: '1-12 ส.ค.',  discount: '-',    channel: 'ร้าน',        impact: 'mid' }
];
